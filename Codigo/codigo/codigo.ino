...
int MAX_SCORE = 2; //PUNTAJE MÁXIMO
int ball_width = 5;
int ball_height = 5;
...
uint8_t ball_x = 300, ball_y = 240/2;
uint8_t ball_dir_x = 0, ball_dir_y = 10;
...
void setup() {
  ...
  //DIBUJAMOS LA CANCHA
  Rect(10, 50, x_limit, y_limit, WHITE);
...
void loop() {
    ...
    FillRect(ball_x, ball_y, ball_width, ball_height, WHITE);
    delay(BALL_RATE);
    FillRect(ball_x, ball_y, ball_width, ball_height, BLACK);
    if (gameIsRunning==true){
      
      if (ball_x>300 | ball_x<20){
        ball_dir_x = -ball_dir_x;
      }
      if (ball_y>239 | ball_y<65) {
