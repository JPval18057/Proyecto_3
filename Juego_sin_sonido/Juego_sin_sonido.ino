...
//***************************************************************************************************************************************
//TO DO LIST
/* CONECTAR TARGETA SD Y GUARDAR LOS PUNTAJES EN UN .TXT
...
void update_math(void){
  if (gameIsRunning==true){
    ...
    Y1 = map(POT1, 0, 4095/(2*2*2*2*2*2*2), 50, 240-P1_HEIGHT);
    Y2 = map(POT2, 0, 4095/(2*2*2*2*2*2*2), 50, 240-P2_HEIGHT);
}
